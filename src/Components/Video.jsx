    ...
    <Stack direction={['column','row']} h={'100vh'}>
        ...
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
                ...
                <Text>
                    Description: Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius at minus delectus enim, numquam corporis aut, reiciendis fugiat ex molestiae impedit! Est vitae, dolorem in fugiat nostrum molestiae dolor repudiandae.
